...
(function() {
  ...
  window.sharejs.extendDoc('attach_editable', function(elem) {
    ...
    // $("#restoreX").click(function(){
    //   restoreS();
    // });
    // $("#range").click(function(){
    //   if(elementContainsSelection(document.getElementById("realEditor"))) console.log("GOOD");
    //   sel = window.getSelection();
    //   $("#editor").editable("setSelection", sel.anchorNode, sel.baseOffset, sel.focusNode, sel.extentOffset + 1);
    // });
    // ************************************************************************************************************** //
